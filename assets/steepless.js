			...
			React.createElement("div", null, 
				...
				React.createElement("div", {id: "sidebar"}, 
					React.createElement("header", null, 
						React.createElement("h1", null, React.createElement(Icon, {type: "mountains", width: "24", height: "24"}), "Travelogic")
					), 
		...
		if (data && data.length){
			...
			return (
				React.createElement("div", {id: "routes-container"}, 
					...
					React.createElement("p", null, "Try an example: ", React.createElement("a", {href: "#walking/Bandung, Indonesia/Jakarta, Indonesia"}, "Walking from Bandung to Jakarta"))
				)
			)
		}
	}
