	...
	render: function(){
		...
		return (
			<div>
				...
				<div id="sidebar">
					<header>
						<h1><Icon type="mountains" width="24" height="24"></Icon>Travelogic</h1>
					</header>
		...
		if (data && data.length){
			...
			return (
				<div id="routes-container">
					...
					<p>Try an example: <a href="#walking/Bandung, Indonesia/Jakarta, Indonesia">Walking from Bandung to Jakarta</a></p>
				</div>
			)
		}
	}
